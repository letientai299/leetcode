...
// the **concatenation** of the **letter values** of each letter in `s`, which
...
//
// Return `true` _if the **summation** of the **numerical values** of_
// `firstWord` _and_ `secondWord` _equals the **numerical value** of_
// `targetWord` _, or_ `false` _otherwise._
//
// **Example 1:**
//
// ```
