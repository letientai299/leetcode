...
//
// Given an integer `num`, **reverse** `num` to get `reversed1`, **then
// reverse** `reversed1` to get `reversed2`. Return `true` _if_ `reversed2`
// _equals_ `num`. Otherwise return `false`.
//
// **Example 1:**
//
// ```
