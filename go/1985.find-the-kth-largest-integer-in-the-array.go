...
//
// Return _the string that represents the_ `kth` _**largest integer** in_
// `nums`.
//
...
func kthLargestNumber(nums []string, k int) string {
	// fastest solution would be using quick select, but my implementation of it
	// is buggy, so, just use this one.
