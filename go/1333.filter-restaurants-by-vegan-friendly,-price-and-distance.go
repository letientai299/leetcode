...
// **rating** from highest to lowest. For restaurants with the same rating,
// order them by _**id**_ from highest to lowest. For simplicity
// `veganFriendlyi` and `veganFriendly` take value _1_ when it is _true_, and
// _0_ when it is _false_.
//
// **Example 1:**
//
// ```
...
func filterRestaurants(restaurants [][]int, veganFriendly int, maxPrice int, maxDistance int) []int {
	...
	for _, r := range restaurants {
		if veganFriendly == 1 && r[2] != veganFriendly {
			continue
		}
