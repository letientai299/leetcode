...
// world hello world"` are all sentences. Words consist of **only** uppercase
// and lowercase English letters.
//
// Two sentences `sentence1` and `sentence2` are **similar** if it is possible
...
//
// Given two sentences `sentence1` and `sentence2`, return `true` _if_
// `sentence1` _and_ `sentence2` _are similar._ Otherwise, return `false`.
//
// **Example 1:**
//
// ```
