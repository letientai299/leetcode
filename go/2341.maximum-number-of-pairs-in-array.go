...
//
// Return _a **0-indexed** integer array_ `answer` _of size_ `2` _where_
// `answer[0]` _is the number of pairs that are formed and_ `answer[1]` _is the
// number of leftover integers in_ `nums` _after doing the operation as many
// times as possible_.
//
// **Example 1:**
//
