...
func checkPalindromeFormation(a string, b string) bool {
	var isPalindrome func(l, r int, left, right string, switched bool) bool

	isPalindrome = func(l, r int, left, right string, canSwitch bool) bool {
		if l >= r {
			return true
		}

		if left[l] == right[r] {
			return isPalindrome(l+1, r-1, left, right, canSwitch)
		}
		...
		return isPalindrome(l, r, left, left, !canSwitch) ||
			isPalindrome(l, r, right, right, !canSwitch)
	}

	n := len(a)
	if isPalindrome(0, n-1, a, a, false) ||
		isPalindrome(0, n-1, b, b, false) {
		return true
	}

	if isPalindrome(0, n-1, a, b, true) {
		return true
	}

	if isPalindrome(0, n-1, b, a, true) {
		return true
	}
