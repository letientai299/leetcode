...
//
// _Return the number of **pseudo-palindromic** paths going from the root node
// to leaf nodes._
//
// **Example 1:**
//
...
func pseudoPalindromicPaths(root *TreeNode) int {
	...
	var walk func(n *TreeNode, odd int)
	walk = func(n *TreeNode, odd int) {
		if n == nil {
			return
		}

		freq[n.Val]++
		odd += (freq[n.Val]%2)*2 - 1
