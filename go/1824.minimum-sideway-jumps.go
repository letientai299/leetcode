...
// laneand wants to jump to point `n`. However, there could be obstacles along
// the way.
//
...
// the frog can also perform a **side jump** to jump to **another** lane (even
// if they are not adjacent) at the **same** point if there is no obstacle on
// the new lane.
//
...
// TODO (tai): slow, O(2n), this could be O(n)
