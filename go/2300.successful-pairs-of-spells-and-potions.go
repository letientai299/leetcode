...
// number of **potions** that will form a successful pair with the_ `ith`
// _spell._
//
// **Example 1:**
//
...
func successfulPairs(spells []int, potions []int, success int64) []int {
	...
	for i, s := range spells {
		...
		p := int(success / int64(s))
		if success%int64(s) > 0 {
			p++
		}
		j := sort.SearchInts(potions, p)
		spells[i] = len(potions) - j
	}
	return spells
}

// TODO (tai): can be linear time
