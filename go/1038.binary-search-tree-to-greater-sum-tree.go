...
func bstToGst(root *TreeNode) *TreeNode {
	// try a different idea compare to 538
	var walk func(n *TreeNode, right int) int

	walk = func(n *TreeNode, right int) int {
		if n == nil {
			return right
		}

		v := walk(n.Right, right)
		n.Val += v
		return walk(n.Left, n.Val)
	}
